...
from PyQt5.QtGui import QPixmap, QFont # TODO: update import
...
# been dragged to different places - make sure you add the stuff 
# you added in pid-graph branch as well
...
# NOTE: Below functions are all in CANWindowLoggingMixin
    ...
    # NOTE: In CAN_window_controls.py
    ...
    # NOTE: moved to CAN_window_controls.py
