...
# Salinity data frame: set range of actual to be 0-120
def parse_0x12X_frame(data_hex):
    ...
    if (actual < 1 and actual != 0 or actual > 120):
...
# temp data frame: range is between -30, 180
