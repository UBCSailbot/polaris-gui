...
def create_label(title, min_width=value_label_min_width):
    label = QLabel(title)
...
class CANWindow(QWidget):
    ...
    def init_ui(self):
        ...
        pdb_temp_labels_layout = QHBoxLayout()
        pdb_volt_labels_layout = QHBoxLayout()
        for i in range(0, 3):
            pdb_temp_labels_layout.addWidget(pdb_objs[i].label)
        for i in range(3, 7):
