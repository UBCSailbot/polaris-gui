...
from PyQt5.QtWidgets import (
    QApplication, QWidget, QLabel, QTabWidget, QLineEdit, QPushButton, QVBoxLayout,
...
# String of hex bytes in little endian format --> signed integer
...
# String of hex bytes in big endian --> Two's complement hex string in big endian
...
class CANWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.volt_values_label.setMinimumWidth(500)
        ...
        self.rudder_values_label.setMinimumWidth(500)
        ...
        right_graphs_layout = QGridLayout()
        ...
        right_graphs_layout.addWidget(self.temp_canvas, 0, 0)
        right_graphs_layout.addWidget(self.volt_canvas, 1, 0)
        right_graphs_layout.addWidget(self.rudder_canvas, 2, 0)
        right_graphs_layout.addWidget(self.pH_canvas, 0, 1)
        right_graphs_layout.addWidget(self.temp_sensor_canvas, 1, 1)
        right_graphs_layout.addWidget(self.sal_canvas, 2, 1)
        ...
        # graphs_widget.setLayout(right_graphs_layout) # Note that widgets can't be displayed simultaneously
        # in different places; they will be "re-parented" - need to create duplicate instances
